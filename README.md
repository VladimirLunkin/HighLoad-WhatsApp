...
| nginx      | Web-server<br />Reverse proxy    | Самый лучший веб-сервер на данный момент. Быстрая настройка  |
...
| Amazon S3  | Файловое хранилище               | Высокой надежность, доступность, производительностью и безопасность |
