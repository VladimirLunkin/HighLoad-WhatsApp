...
Расчитаем количество серверов:

335 / 64 = 6 серверов

Так как будет использовано реплецирование, серверов потребуется в три раза больше, значит для хранения сообщений нам необходимо 18 серверов.
